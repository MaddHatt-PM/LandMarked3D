...
if event_name[0:3] == 'it-':
    key_name = 'IT_' + key_name[2:]
...
fromMainPath = Path("../src/IPCEvents/ipc-from-main-events.ts")
toMainPath = Path("../src/IPCEvents/ipc-to-main-events.ts")
...
for target in targets:
    ...
    if key_name in output or event_name in output:
        ...
        print("   {}:{}".format(key_name, event_name))
        print("   Aborting...")
        sys.exit(1)
